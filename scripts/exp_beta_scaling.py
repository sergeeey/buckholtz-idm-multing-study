...
print("=" * 70)
print()
print("  Hypothesis: β_l = (9/2) × l²  [HYPOTHESIS, not VERIFIED]")
print()
print("  Evidence FOR:")
print("  ✓ Claude/NotebookLM extraction: β_d=4.5, β_q=18 → ratio=4=2² (exact)")
print("  ✓ Physical mechanism: classical rotational KE ∝ l²")
print("  ✓ C=9/2 = D²/2 where D=3 (spatial dimensions)")
print("  ✓ Predicts β_octupole=40.5 (falsifiable if paper mentions l=3 term)")
print()
print("  Evidence AGAINST:")
print("  ✗ Gemini extraction: β_q=8.10 → ratio=1.9 ≠ 4 (inconsistent)")
print("  ✗ ChatGPT: ratio=0.24 (opposite direction)")
print("  ✗ 16× spread in ratio across services → extraction-dependent")
print("  ✗ Paper describes β as 'phenomenological' — may not obey any law")
print()
print("  VERDICT: SPECULATIVE [CANDIDATE]")
print("  Required to promote: verify β_d, β_q from paper text directly,")
print("  OR find octupole β_3 in paper and check if β_3 ≈ 40.5.")
print()
print("  Score for paper integration: 6/10 — useful framing,")
print("  but extraction inconsistency is a hard blocker for claims.")
