...
in mass units (Higgs prediction $0.44\sigma$, though the $W$ boson deviates by
$3.6\sigma$), and the fermion-gravity link (Eq.~32) holds at $0.17\sigma$ ---
...
across the three masses --- here the $W$ boson at $\approx 3.6\sigma$ --- not
...
$W$-boson residual ($\approx 3.6\sigma$ when $Z$-anchored, vs $0.44\sigma$ for
