...
No alternative integer pair exists in this range.
...
This look-elsewhere correction is independent of the $3.8\sigma$ $W$-boson
discrepancy from the PDG mean: that discrepancy reflects the tension between
the predicted value $m_W^{\rm pred} = 80.420$~GeV and the PDG-2024 average,
not the uniqueness of the integer pattern.\reconstruction
